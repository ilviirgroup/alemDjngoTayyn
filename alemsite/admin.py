...
class OrderAdmin(admin.ModelAdmin):
    list_display = ('name', 'ai','get_color','completed', 'date', 'quantity', 'get_size')
...
class ProductsAdmin(admin.ModelAdmin):
    list_display = ('id', 'name', 'description', 'category', 'subcategory', 'get_color',  'price', 'brand', 'gender',
                    'get_size', 'status', 'new', 'get_photo', 'get_photo1', 'get_photo2', 'get_photo3')
